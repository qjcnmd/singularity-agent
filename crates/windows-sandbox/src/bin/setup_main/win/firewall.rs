...
use singularity_windows_sandbox::network_controls::{
...
use singularity_windows_sandbox::product_identity::{
    ...
    FIREWALL_OFFLINE_BLOCK_LOOPBACK_UDP_RULE_FRIENDLY as OFFLINE_BLOCK_LOOPBACK_UDP_RULE_FRIENDLY,
    FIREWALL_OFFLINE_BLOCK_LOOPBACK_UDP_RULE_NAME as OFFLINE_BLOCK_LOOPBACK_UDP_RULE_NAME,
    FIREWALL_OFFLINE_BLOCK_RULE_FRIENDLY as OFFLINE_BLOCK_RULE_FRIENDLY,
