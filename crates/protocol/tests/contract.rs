...
fn turn_event_wire_goldens() {
    ...
    let cases: Vec<(&str, TurnEvent, &str)> = vec![
        ...
        (
            ...
            r#"{"attempt":1,"attemptDurationMs":null,"inputTokens":null,"outputTokens":null,"cachedInputTokens":null,"diagnosticCode":null,"errorCategory":null,"model":"test-model-a","requestId":"","modelTurnOrdinal":3,"purpose":"generation","protocol":"openai_chat_completions","provider":"openai_compatible","retryAfterMs":null,"retryAfterSource":null,"status":"started","threadId":"thread-1","turnId":"turn-1"}"#,
        ),
        (
            "provider/attempt",
            TurnEvent::ProviderAttempt {
            ...
            r#"{"attempt":2,"attemptDurationMs":421,"inputTokens":120,"outputTokens":30,"cachedInputTokens":20,"diagnosticCode":"provider_retry_scheduled","errorCategory":"rate_limited","model":"test-model-a","requestId":"","modelTurnOrdinal":3,"purpose":"generation","protocol":"openai_responses","provider":"openai_compatible","retryAfterMs":750,"retryAfterSource":"provider_header","status":"error","threadId":"thread-1","turnId":"turn-1"}"#,
        ),
        (
            "turn/completed",
