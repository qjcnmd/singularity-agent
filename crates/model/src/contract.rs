...
pub(super) fn request_uses_tool_protocol(request: &ModelTurnRequest) -> bool {
...
pub(super) fn provider_request_validation_error(
...
pub(super) fn model_error_category(error: &ModelError) -> ModelErrorCategory {
    match error.kind {
...
pub(super) fn message_text(message: &ModelMessage) -> &str {
    &message.content
}
