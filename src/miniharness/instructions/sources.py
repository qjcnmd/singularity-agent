...
SYSTEM_INVARIANTS = "\n".join(
    [
        "MiniHarness is a local CLI coding agent harness.",
    ...
    def collect_sources(
        ...
        *,
        ...
        sources = [
            ...
            self._source(
                source_type=InstructionSourceType.HARNESS,
                origin="miniharness.harness",
                priority=InstructionPriority.HARNESS_DEVELOPER,
                trust_level=TrustLevel.TRUSTED_HARNESS,
                content=(
                    HARNESS_DEVELOPER_INSTRUCTIONS
