...
from miniharness.model.models import ContentBlock, ModelMessage, ModelRole
...
class PromptCompiler:
        ...
        if self.config.include_instruction_hierarchy_notice:
            sections.insert(
                ...
                PromptSection(
                    ...
                    source_refs=[],
                    content=(
                        "Instruction priority is system > harness developer > "
    ...
    def _title(frame: InstructionFrame) -> str:
        ...
        if frame.effective_priority == InstructionPriority.HARNESS_DEVELOPER:
            return "Harness developer instructions"
    ...
    def _messages(
        ...
        *,
        ...
        folded = False
        if not system_parts:
            system_parts.append("You are Miniharness, a local CLI coding agent harness.")
