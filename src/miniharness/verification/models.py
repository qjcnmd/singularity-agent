...
from miniharness.command import CommandPolicyResult, CommandRequest
...
class VerificationCheck:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            "id": self.id,
            "kind": self.kind.value,
            "command": self.command.display_command() if self.command else None,
            "argv": self.command.argv if self.command else None,
