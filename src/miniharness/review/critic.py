...
from miniharness.review.models import ReviewCategory, ReviewFinding, ReviewReport, ReviewSeverity
...
def _critic_prompt(report: ReviewReport, bundle: dict[str, Any]) -> str:
    payload = {
        "instruction": (
            "Review this local MiniHarness change bundle. Return only JSON with a "
