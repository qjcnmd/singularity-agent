...
from miniharness.plugins.compatibility import compatibility_status
...
class PluginStatusStore:
    def __init__(self, project_root: Path | str) -> None:
        ...
        self.path = self.project_root / ".miniharness" / "plugin-status.json"
...
class PluginLockStore:
    def __init__(self, project_root: Path | str) -> None:
        self.project_root = Path(project_root).resolve(strict=False)
        self.path = self.project_root / ".miniharness" / "plugin-lock.json"
