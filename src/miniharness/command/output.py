...
from miniharness.command.models import ResourceLimits
from miniharness.command.policy import is_secret_env_name
...
class OutputCollector:
    def __init__(
        ...
        *,
        ...
        self._lock = Lock()
        self._artifact_path = (
            workspace_root / ".miniharness" / "artifacts" / "commands" / f"{command_id}.log"
        )
