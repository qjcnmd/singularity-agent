...
class EditExecutor:
    def __init__(
        ...
        *,
        ...
        self.mutation_manager = mutation_manager or WorkspaceMutationManager(self.workspace_root)
        ...
        self.repair = EditRepairController(self.mutation_manager)
    ...
    def write_file(
        ...
        *,
        ...
        resolved = self.mutation_manager.resolver.resolve(path)
        ...
        result = self.mutation_manager.apply_file_updates(
        ...
        self._emit(
            ...
            "write_file facade delegated through EditExecutor.",
            {
                "path": resolved.relative_posix,
                "mode": mode,
    ...
    def apply_unified_diff(
        ...
        *,
        ...
        self._emit(
            TraceEventType.EDIT_APPLIED if result.ok else TraceEventType.EDIT_FAILED,
            "apply_patch facade delegated through EditExecutor.",
            {
    ...
    def _single_pass(self, intent: EditIntent, *, apply: bool, tool_call_id: str | None) -> EditResult:
        ...
        self._emit(
            ...
            "Edit applied through WorkspaceMutationManager." if mutation.ok else "Edit apply failed.",
            self._trace_payload(result),
    ...
    def _pre_edit_review(
        ...
        *,
        ...
        if self.review_pipeline is None or not hasattr(self.review_pipeline, "pre_edit_review"):
            return None
        return self.review_pipeline.pre_edit_review(
            intent=intent,
            plan=plan,
            patch=candidate,
            validation=validation,
    ...
    def _post_patch_review(self, result: EditResult) -> Any | None:
        if self.review_pipeline is None or not hasattr(self.review_pipeline, "post_patch_review"):
            return None
        return self.review_pipeline.post_patch_review(
    ...
    def _plan_verification(
        ...
        *,
        ...
        if self.verification_runner is None or not changed_files:
            return None
    ...
    def _post_apply_impact(self, changed_files: list[str]) -> tuple[dict[str, Any] | None, dict[str, Any] | None]:
        if self.project_index is None or not changed_files:
            return None, None
        try:
            impact = self.project_index.analyze_impact(changed_files)
            tests = self.project_index.get_test_impact(changed_files)
        except Exception:
            return None, None
        return (
