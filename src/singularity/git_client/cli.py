...
def git_status(
    ...
    payload = GitClient(resolve_project_root(project_root)).status().to_dict()
...
def git_diff(
    ...
    payload = GitClient(resolve_project_root(project_root)).diff_stat(staged=staged).to_dict()
...
def git_commit(
    ...
    result = GitClient(resolve_project_root(project_root)).commit(
        message,
