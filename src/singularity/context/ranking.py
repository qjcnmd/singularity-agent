...
CONTEXT_PINNED_ITEM_SCORE_BONUS = 100.0
CONTEXT_PHASE_MATCH_SCORE_BONUS = 10.0
CONTEXT_CURRENT_FRESHNESS_SCORE_BONUS = 2.0
CONTEXT_STALE_FRESHNESS_SCORE_PENALTY = -2.0

CONTEXT_COMPACTION_WEIGHT_SCALE = 100.0
CONTEXT_COMPACTION_PINNED_SCORE_BONUS = 10.0
CONTEXT_COMPACTION_STALE_FRESHNESS_SCORE_PENALTY = -1.0

CONTEXT_VOLATILITY_RECENT_OR_FAILURE = 1.0
CONTEXT_VOLATILITY_MESSAGE_OR_FAILURE = 0.8
CONTEXT_VOLATILITY_EVIDENCE = 0.5
CONTEXT_VOLATILITY_DEFAULT = 0.2

CONTEXT_RECENCY_CURRENT = 1.0
CONTEXT_RECENCY_STALE = 0.3
CONTEXT_RECENCY_DEFAULT = 0.0

CONTEXT_REFERENCE_DENSITY_PRECISION = 4
