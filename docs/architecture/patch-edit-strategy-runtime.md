...
- MutationRuntime policy decisions for forbidden and review-required paths
...
Trace and context evidence are bounded to ids, strategy, changed file paths, diff digests, validation issue codes, repair summaries, changeset/transaction ids, and verification plan ids. Large file contents and full diffs stay in MutationRuntime artifacts.
