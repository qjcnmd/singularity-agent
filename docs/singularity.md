...
> 基于当前源码核对：Rust `crates/cli`、`crates/app-server`、`crates/protocol`、`crates/agent`、`crates/tools`、`crates/sandbox`、`crates/store`，以及 Python oracle/parity/dev-only 参考模块。
