...
/** 所有已配置 variant 都可选；off 控制 thinking 关闭。排序只消费变体数组本身：
 *  返回排序后的副本，不改动输入，未知档位按它们在输入中的稳定次序排在已知档位之后。 */
export function sortReasoningVariants(variants: readonly ReasoningVariant[] | null | undefined): ReasoningVariant[] {
