...
export type ProviderConfigurationInput = { apiProtocol: string | null, providerId: string, displayName: string | null, baseUrl: string, models: Array<ModelConfigurationInput>, };
 ...
 */
manuallyStopped: boolean, message: string | null, };
 ...
 */
startedAt?: string, finishedAt?: string, turnId: string | null,
/**
