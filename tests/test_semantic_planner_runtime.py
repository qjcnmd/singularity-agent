...
from singularity.planner import PlannerRuntime, SemanticPlannerRuntime, TaskContractBuilder, TaskStatus
...
def test_semantic_planner_generates_multi_requirement_rolling_plan() -> None:
    ...
    plan = SemanticPlannerRuntime().initial_plan(contract)
...
def test_repair_step_binds_failed_acceptance_criterion() -> None:
    ...
    plan = SemanticPlannerRuntime().repair_plan(analysis, task_contract=contract)
