...
def test_sensitive_result_is_not_cached(tmp_path: Path) -> None:
    ...
    runtime.execute_tool_call(make_tool_call("secretish", tool_call_id="call_secret_1"))
    runtime.execute_tool_call(make_tool_call("secretish", tool_call_id="call_secret_2"))
...
def test_idempotent_false_is_not_cached(tmp_path: Path) -> None:
    ...
    runtime.execute_tool_call(make_tool_call("non_idempotent", tool_call_id="call_non_idem_1"))
    second = runtime.execute_tool_call(make_tool_call("non_idempotent", tool_call_id="call_non_idem_2"))
...
def test_cache_can_be_invalidated_by_path(tmp_path: Path) -> None:
    ...
    runtime.invalidate_paths(["a.txt"])
...
def test_cacheable_tool_call_id_conflict_is_rejected(tmp_path: Path) -> None:
    ...
    first = runtime.execute_tool_call(make_tool_call("cached_echo", {"value": "x"}))
    second = runtime.execute_tool_call(make_tool_call("cached_echo", {"value": "y"}))
...
def test_cache_hit_still_records_tool_call_id_for_conflict_detection(tmp_path: Path) -> None:
    ...
    cached = runtime.execute_tool_call(
        make_tool_call("cached_echo", {"value": "x"}, tool_call_id="call_cached")
    )
    conflict = runtime.execute_tool_call(
